 ...
 * @version   $Id: Monthly.php 112 2011-08-21 12:07:20Z hssh $
 */
 ...
 * @package  ZendEx_File_Rotator_Period
 */
class ZendEx_File_Rotator_Period_Monthly extends ZendEx_File_Rotator_Period_Abstract {
    /**
    ...
    protected function _getSuffix() {
        return $this->_mdate instanceof Zend_Date ? $this->_mdate->toString("yyyyMM") : null;
    }
    ...
    protected function _isNeedRotation() {
        return $this->_mdate instanceof Zend_Date &&
               (Zend_date::now()->toString("yyyyMM") > $this->_mdate->toString("yyyyMM"));
    }
     ...
     * @return ZendEx_File_Rotator_Period_Monthly
     */
